...
public class TuringApiUtils {
    ...
    public String sendToTuringApi(String requestString) {
        System.out.println(turingConfigure);
        final String url = turingConfigure.getUrl();
        final TuringRequestDTO turingRequestDTO = createTuringRequestDTO(requestString);
        ResponseEntity<String> responseEntity = restTemplate.postForEntity(url, turingRequestDTO, String.class);
